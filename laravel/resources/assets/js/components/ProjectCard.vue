<template>
    <article @click="openModal" class="tile is-child notification is-primary">
        ...
        <p class="subtitle is-6"> {{project.name}} content</p>
        ...
        <EditProjectModal @UPDATE_PROJECT="updateProject" @CLOSE_MODAL="closeModal" v-if="open" :status="status" :project="project"/>
    </article>
</template>
